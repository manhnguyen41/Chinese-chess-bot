    ...
    def select_child(self, exploration_constant=1.4):
        ...
        for child in self.children:
            if child.visits == 0:  # Kiểm tra xem số lượt truy cập của node con có phải là 0 không
                ...
                exploitation = float(child.score // child.visits)  # Tính exploitation score
                exploration = float(math.sqrt(2 * math.log(self.visits) // child.visits))  # Tính exploration score
