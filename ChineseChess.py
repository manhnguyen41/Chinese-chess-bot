...
AI_AVATAR_CENTER = (AI_PLAYER_AVATAR_POS[0] + PLAYER_AVATAR_SIZE // 2 , AI_PLAYER_AVATAR_POS[1] + PLAYER_AVATAR_SIZE // 1.5)
...
def draw_board(valid_destinations=None):
    ...
    if valid_destinations:
        for dest_row, dest_col in valid_destinations:
            pygame.draw.circle(screen, DOT_COLOR, (BOARD_OFFSET_X + dest_col * CELL_SIZE, BOARD_OFFSET_Y + dest_row * CELL_SIZE), 4)
...
def draw_player_avatar(time_left_player1, time_left_player2):
    ...
    human_text_rect = human_text.get_rect(center=(HUMAN_PLAYER_AVATAR_POS[0] + PLAYER_AVATAR_SIZE // 2, HUMAN_PLAYER_AVATAR_POS[1] + PLAYER_AVATAR_SIZE * 1.2))
    ...
    AI_text_rect = AI_text.get_rect(center=(AI_PLAYER_AVATAR_POS[0] + PLAYER_AVATAR_SIZE // 2, AI_PLAYER_AVATAR_POS[1] + PLAYER_AVATAR_SIZE * 1.2))
...
def draw_dot(current_player):
    if current_player == '1':
        pygame.draw.circle(screen, (0, 0, 0), (HUMAN_PLAYER_AVATAR_POS[0] + PLAYER_AVATAR_SIZE // 2 - 50, HUMAN_PLAYER_AVATAR_POS[1] + PLAYER_AVATAR_SIZE * 1.2), 5)
    else:
        pygame.draw.circle(screen, (0, 0, 0), (AI_PLAYER_AVATAR_POS[0] + PLAYER_AVATAR_SIZE // 2 - 50, AI_PLAYER_AVATAR_POS[1] + PLAYER_AVATAR_SIZE * 1.2), 5)
...
def move_piece(selected_piece, destination_square, board, game_state, current_player):
...
def main():
    ...
    print(start_ticks_player1)
    print(start_ticks_player2)
    ...
    while running:
        ...
        if selected_piece:
            ...
            if name == 'to11' or name == 'to21' or name == 'to31' or name == 'to41' or name == 'to41' or name == 'to12' or name == 'to22' or name == 'to32' or name == 'to42' or name == 'to52':
